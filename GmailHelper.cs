   ...
   public static class GmailHelper
    {
        ...
        public static GmailService GetService()
        {
            ...
            using (FileStream stream = new FileStream(Convert.ToString(ConfigurationManager.AppSettings["ClientSecret"]),
        ...
        public static List<object> GetAttachments(string userId, string messageId, String outputDir)
        {
            try
            {
                List<object> FileObj = new List<object>();
                ...
                foreach (MessagePart part in parts)
                {
                    if (!String.IsNullOrEmpty(part.Filename))
                    {
                        ...
                        var obj = new {
                            Path= Path.Combine(outputDir, part.Filename),
                            Data=data
                        };
                        FileObj.Add(obj);
                    }
